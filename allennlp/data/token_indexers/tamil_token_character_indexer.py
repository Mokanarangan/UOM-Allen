...
from allennlp.data.tokenizers.tamil_character_tokenizer import CharacterTokenizer


@TokenIndexer.register("tamil_characters")
class TamilTokenCharactersIndexer(TokenIndexer[List[int]]):
    """
    ...
    def pad_token_sequence(self,
        ...
        padded_tokens = pad_sequence_to_length(
            tokens, desired_num_tokens, default_value=self.get_padding_token)
